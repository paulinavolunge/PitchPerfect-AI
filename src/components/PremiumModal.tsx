      ...
      <DialogContent className="sm:max-w-lg bg-white border shadow-xl">
        ...
        <div className="space-y-6 py-6">
          <div className="space-y-4">
            {premiumFeatures.map((feature, index) => <div key={index} className="flex items-start space-x-3">
          ...
          <div className="flex flex-col space-y-3 pt-4 border-t border-gray-200">
            {!user ? <>
                <Button onClick={handleSignUp} className="w-full bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white font-semibold py-3">
                  Sign Up Free
                </Button>
                ...
                <Button onClick={handleUpgrade} className="w-full bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white font-semibold py-3">
                  {creditsRemaining === 0 ? 'Top Up Credits' : 'Upgrade to Premium'}
                </Button>
                <Button variant="outline" onClick={onClose} className="w-full border-gray-300 text-gray-700 hover:bg-gray-50">
                  Maybe Later
                </Button>
              </>}
          </div>
