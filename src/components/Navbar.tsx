              ...
              {user ? (
                <>
                  {userNavigationItems.map((item) => (
                    <Link key={item.name} to={item.href} className="block py-2 text-brand-dark hover:text-brand-blue">{item.name}</Link>
                  ))}
          ...
          {user ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                {userNavigationItems.map((item) => (
                  <DropdownMenuItem key={item.name} onClick={() => navigate(item.href)}>{item.name}</DropdownMenuItem>
                ))}
                <DropdownMenuSeparator />
            ...
            <>
              {guestNavigationItems.map((item) => (
                <Link key={item.name} to={item.href} className="text-sm text-brand-dark hover:text-brand-blue">{item.name}</Link>
              ))}
