    ...
    <div className="space-y-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm relative">
        <AIContentBadge 
          ...
          tooltipContent="This feedback was generated by AI based on your pitch"
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-green-50 p-4 rounded-lg relative">
          <AIContentBadge 
            ...
            tooltipContent="AI-identified strengths based on your pitch"
          />
        ...
        <div className="bg-amber-50 p-4 rounded-lg relative">
          <AIContentBadge 
            type="icon" 
            size="sm" 
            className="absolute top-2 right-2"
            tooltipContent="AI-identified areas for improvement based on your pitch"
          />
